    ...
    <div v-if="event" class="fixed inset-0 z-40" @click="closePopup">
      ...
      >
        ...
        <div class="mt-4 pt-4 p-4">
          ...
          <p class="text-gray-700"><strong>Nom :</strong> {{ event.client?.name }}</p>
          <p class="text-gray-700"><strong>Adresse :</strong> {{ event.client?.address }}</p>
          <p class="text-gray-700"><strong>Contact :</strong> {{ event.client?.phone }}</p>
        </div>
